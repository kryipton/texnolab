...
class TeachersController extends MY_Controller{
    ...
    public function __construct()
    {
        ...
        $this->table_name_in_azeri = "Müəllimlər";
        ...
        $this->table_field_names = array(
            ...
            "Haqqında Qısa Məlumat (Az) (visible)",
            "Haqqında Qısa Məlumat (En)",
            "Haqqında Qısa Məlumat (Ru)",
        ...
        $this->label_name_and_input_name = array(
            ...
            "Müəllimin Haqqında Qısa Məlumat (Az)" => "(group1)wider_desc_az",
            "Müəllimin Haqqında Qısa Məlumat (En)" => "(group1)wider_desc_en",
            "Müəllimin Haqqında Qısa Məlumat (RU)" => "(group1)wider_desc_ru",

            "Müəllimin vəzifəsi (Az)" => "(group2)job_az",
            "Müəllimin vəzifəsi (En)" => "(group2)job_en",
            "Müəllimin vəzifəsi (Ru)" => "(group2)job_ru",

            "Müəllimin facebook heasbının linki" => "facebook",
            "Müəllimin instagram heasbının linki" => "instagram",
            "Müəllimin twitter heasbının linki" => "twitter",



            "Müəllim Haqqında (Az)" => "(group2)desc_az",
            "Müəllim Haqqında (En)" => "(group2)desc_en",
            "Müəllim Haqqında (Ru)" => "(group2)desc_ru",
