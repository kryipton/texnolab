...
class AboutPageBackgroundController extends MY_Controller{
    ...
    public function __construct()
    {
        ...
        //      tablemizin adi
        $this->table_name = "about_page_background";

        //      tablemizin az dilinde adi
        $this->table_name_in_azeri = "Haqqımızda səhifəsinin arxa fon şəkli";
