...
class GalleryPageBackgroundController extends MY_Controller{
    ...
    public function __construct()
    {
        ...
        //      tablemizin adi
        $this->table_name = "gallery_page_background";

        //      tablemizin az dilinde adi
        $this->table_name_in_azeri = "Qalereya səhifəsinin arxa fon şəkli";
