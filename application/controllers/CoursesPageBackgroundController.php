...
class CoursesPageBackgroundController extends MY_Controller{
    ...
    public function __construct()
    {
        ...
        //      tablemizin adi
        $this->table_name = "courses_page_background";

        //      tablemizin az dilinde adi
        $this->table_name_in_azeri = "Kurslar səhifəsinin arxa fon şəkli";
