...
class ClientReviewController extends MY_Controller{
    ...
    public function __construct()
    {
        ...
        $this->table_name_in_azeri = "Müştəri rəyləri";
        ...
        $this->label_name_and_input_name = array(
            "Başlıq (Az)" => "(group1)name_az",
            "Başlıq (En)" => "(group1)name_en",
            "Başlıq (RU)" => "(group1)name_ru",
