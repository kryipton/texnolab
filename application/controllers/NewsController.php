...
class NewsController extends MY_Controller{
    ...
    public function __construct()
    {
        ...
        $this->table_name_in_azeri = "Xəbərlər";
        ...
        $this->label_name_and_input_name = array(
            "Başlıq (Az)" => "(group1)title_az",
            "Başlıq (En)" => "(group1)title_en",
            "Başlıq (RU)" => "(group1)title_ru",

            "Qısa Məlumat (Az)" => "(group1)wider_desc_az",
            "Qısa Məlumat (En)" => "(group1)wider_desc_en",
            "Qısa Məlumat (RU)" => "(group1)wider_desc_ru",
            ...
            "Ətraflı (Az)" => "(group2)desc_az",
            "Ətraflı (En)" => "(group2)desc_en",
    ...
    public function index()
    {
        ...
        $config["select_name_and_table_name"] = array(
            "category_id.Kateqoriyanın Adı" => "news_category.name_az",
        );
    ...
    public function get_data()
    {
        ...
        $config["additional_links"] = array(
            "Qalereya" => "NewsgalleryController/index/"
        );
        $config["table_name"] = $this->table_name;
