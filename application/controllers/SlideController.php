...
class SlideController extends MY_Controller{
    ...
    public function __construct()
    {
        ...
        $this->table_name_in_azeri = "Slayd";

        //      tablenin fieldlerinin az dilinde adi
        $this->table_field_names = array(
            "ID",
            "Əsas Başlıq (Az) (visible)",
            "Əsas Başlıq (En)",
            "Əsas Başlıq (Ru)",
            "İkinci Başlıq (Az) (visible)",
            "İkinci Başlıq (En)",
            "İkinci Başlıq (Ru)",
            "Düymə kontenti (Az) (visible)",
            "Düymə kontenti (En)",
            "Düymə kontenti (Ru)",
            "Yönləndirmə linki (visible)",
            "Şəkil  (visible)",
        );

        //      inputlarin adlari ve labelleri
        $this->label_name_and_input_name = array(
            "Əsas Başlıq (Az)" => "(group1)title_az",
            "Əsas Başlıq (En)" => "(group1)title_en",
            "Əsas Başlıq (RU)" => "(group1)title_ru",

            "İkinci Başlıq (Az)" => "(group2)desc_az",
            "İkinci Başlıq (En)" => "(group2)desc_en",
            "İkinci Başlıq (Ru)" => "(group2)desc_ru",

            "Düymə kontenti (Az)" => "(group2)button_text_az",
            "Düymə kontenti (En)" => "(group2)button_text_en",
            "Düymə kontenti (Ru)" => "(group2)button_text_ru",


            "Yönləndirmə linki" => "button_link",
