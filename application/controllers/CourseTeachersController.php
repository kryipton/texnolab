...
class CourseTeachersController extends MY_Controller{
    ...
    public function __construct()
    {
        ...
        $this->viewed_table = "teachers";

        //      tablemizin az dilinde adi
        $this->table_name_in_azeri = "Kurs Müəllimləri";
        ...
        $this->select = array(
            "teacher_id.Müəllimin Adı" => "teachers.name_az",
        );
