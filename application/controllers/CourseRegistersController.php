...
class CourseRegistersController extends MY_Controller{
    ...
    public function __construct()
    {
        ...
        //      tablemizin adi
        $this->table_name = "course_registers";

        //      tablemizin az dilinde adi
        $this->table_name_in_azeri = "Kurs Qeydiyyatı";
        ...
        $this->table_field_names = array(
            ...
            "Kurs İd",
            "Ad Soyad (visible)",
            "Telefon nömrəsi (visible)",

            "Komment bölməsi (visible)",
