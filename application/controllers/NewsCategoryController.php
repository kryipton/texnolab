...
class NewsCategoryController extends MY_Controller{
    ...
    public function __construct()
    {
        ...
        $this->table_name_in_azeri = "Xəbərlər Kateqoriyası";

        //      tablenin fieldlerinin az dilinde adi
        $this->table_field_names = array(
            "ID",
            "Kateqoriya adı (Az) (visible)",
            "Kateqoriya adı (En)",
            "Kateqoriya adı (Ru)",
        );
        ...
        $this->label_name_and_input_name = array(
            "Kateqoriya adı (Az)" => "(group1)name_az",
            "Kateqoriya adı (En)" => "(group1)name_en",
            "Kateqoriya adı (RU)" => "(group1)name_ru",
        );
