...
class NewsgalleryController extends MY_Controller{
    ...
    public function __construct()
    {
        ...
        //      tablemizin adi
        $this->table_name = "news_gallery";

        //      tablemizin az dilinde adi
        $this->table_name_in_azeri = "Foto Kataloq";

        //      geri butonuna basanda hansi linke geri atsin
        $this->prev_link = base_url("NewsController");
