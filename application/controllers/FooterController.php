...
class FooterController extends MY_Controller{
    ...
    public function __construct()
    {
        ...
        $this->label_name_and_input_name = array(
            ...
            "Haqqımızda ətraflı (Az)" => "(group2)desc_az",
            "Haqqımızda ətraflı (En)" => "(group2)desc_en",
            "Haqqımızda ətraflı (Ru)" => "(group2)desc_ru",

            "Müəllif Hüquqları (Az)" => "(group2)copyright_az",
            "Müəllif Hüquqları (En)" => "(group2)copyright_en",
            "Müəllif Hüquqları (Ru)" => "(group2)copyright_ru",
