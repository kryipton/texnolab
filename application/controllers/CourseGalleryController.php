...
class CourseGalleryController extends MY_Controller{
    ...
    public function __construct()
    {
        ...
        //      tablemizin adi
        $this->table_name = "course_gallery";

        //      tablemizin az dilinde adi
        $this->table_name_in_azeri = "Kursun Qalereyası";

        //      geri butonuna basanda hansi linke geri atsin
        $this->prev_link = base_url("CoursesController");
        ...
        $this->success_link                   = base_url("$this->class_name/index/$main_id");//bunnarin sonuna slash qoymaq vacibdir yoxsa islemez

        //      proseslerden her hansi biri ugurla basa catmadiqda hansi linke atsin
        $this->error_link                     = base_url("$this->class_name/index/$main_id");//bunnarin sonuna slash qoymaq vacibdir yoxsa islemez
