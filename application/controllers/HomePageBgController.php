...
class HomePageBgController extends MY_Controller{
    ...
    public function __construct()
    {
        ...
        //      tablemizin adi
        $this->table_name = "home_page_bg1";

        //      tablemizin az dilinde adi
        $this->table_name_in_azeri = "Ana səhifə tənzimləmələri";

        //      inputlarin adlari ve labelleri
        $this->label_name_and_input_name = array(
            "Başlıq 1(Az)" => "(group1)text1_az",
            "Başlıq 1(En)" => "(group1)text1_en",
            "Başlıq 1(Ru)" => "(group1)text1_ru",
            "Rəqəm 1" => "num1",


            "Başlıq 2(Az)" => "(group1)text2_az",
            "Başlıq 2(En)" => "(group1)text2_en",
            "Başlıq 2(Ru)" => "(group1)text2_ru",
            "Rəqəm 2" => "num2",


            "Başlıq 3(Az)" => "(group1)text3_az",
            "Başlıq 3(En)" => "(group1)text3_en",
            "Başlıq 3(Ru)" => "(group1)text3_ru",
            "Rəqəm 3" => "num3",

            "Başlıq 4(Az)" => "(group1)text4_az",
            "Başlıq 4(En)" => "(group1)text4_en",
            "Başlıq 4(Ru)" => "(group1)text4_ru",
            "Rəqəm 4" => "num4",
