...
class NewsPageBackgroundController extends MY_Controller{
    ...
    public function __construct()
    {
        ...
        //      tablemizin adi
        $this->table_name = "news_page_background";

        //      tablemizin az dilinde adi
        $this->table_name_in_azeri = "Texno Xəbərlər səhifəsinin arxa fon şəkli";
